...
export default function AdminSubscriptions() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #0B3558 0%, #0B3558 100%)' }}>
      <div className="relative z-10 p-6 max-w-7xl mx-auto">
        ...
        <div className="glass-strong rounded-2xl p-5 mb-6 grid md:grid-cols-2 gap-5">
          <div>
            ...
            <button onClick={generateVisits} className="text-sm px-4 py-2.5 rounded-full bg-white text-[#0B3558] font-semibold hover:bg-white/90">
          ...
          {toolMsg && <div className="md:col-span-2 text-[#7DD3FC] text-sm">{toolMsg}</div>}
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => setSelected(null)}>
          <div className="glass-strong rounded-3xl p-7 w-full max-w-md" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-3">
              ...
              <button onClick={activate} disabled={saving || !price} className="flex-1 py-3 rounded-xl bg-white text-[#0B3558] font-bold hover:bg-white/90 transition disabled:opacity-50 text-sm">
