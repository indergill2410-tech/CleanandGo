    ...
    <section className="px-4 py-5 sm:px-6 lg:px-8">
      <div className="rounded-[8px] border border-[#B9CFDE] bg-[#F8FBFF] p-5 shadow-sm">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          ...
          <label className="flex min-h-11 items-center gap-2 rounded-[8px] border border-[#B9CFDE] bg-[#F7FAFC] px-3 text-sm text-[#5C7180] xl:w-[360px]">
      ...
      <div className="mt-5 overflow-hidden rounded-[8px] border border-[#B9CFDE] bg-[#F8FBFF] shadow-sm">
        {loading ? (
          ...
          <article key={customer.id} className="grid gap-4 border-b border-[#B9CFDE] p-4 last:border-b-0 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
...
function Stat({ label, value, icon: Icon }: { label: string; value: string; icon: typeof UserRoundCheck }) {
  return (
    <section className="rounded-[8px] border border-[#B9CFDE] bg-[#F7FAFC] p-4">
