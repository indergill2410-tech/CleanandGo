    ...
    <main className="min-h-screen" style={{ background: '#F7F3EE' }}>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-[#5F6E78] text-sm mt-8">
      ...
      <section className="py-20 px-6" style={{ background: 'linear-gradient(180deg, #F7F3EE 0%, #EFE7DC 100%)' }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#2F7D6B] font-semibold text-sm uppercase tracking-widest mb-3">Transparency</p>
            <h2 className="text-3xl font-bold text-[#172434]">What affects your price</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {PRICE_FACTORS.map((f) => (
              <div key={f.title} className="bg-white/80 backdrop-blur-sm border border-white/60 rounded-2xl p-6 shadow-sm">
                <div className="text-3xl mb-3">{f.icon}</div>
                <h3 className="font-semibold text-[#172434] mb-2">{f.title}</h3>
                <p className="text-[#5F6E78] text-sm leading-relaxed">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#2F7D6B] font-semibold text-sm uppercase tracking-widest mb-3">Pricing FAQ</p>
            <h2 className="text-3xl font-bold text-[#172434]">Questions about cost</h2>
          </div>
