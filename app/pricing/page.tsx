    ...
    <main className="min-h-screen" style={{ background: '#EFF7FC' }}>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-[#60798F] text-sm mt-8">
      ...
      <section className="py-20 px-6" style={{ background: 'linear-gradient(180deg, #EFF7FC 0%, #DCECF8 100%)' }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#1D7ED0] font-semibold text-sm uppercase tracking-widest mb-3">Transparency</p>
            <h2 className="text-3xl font-bold text-[#0B3558]">What affects your price</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {PRICE_FACTORS.map((f) => (
              <div key={f.title} className="bg-white/80 backdrop-blur-sm border border-white/60 rounded-2xl p-6 shadow-sm">
                <div className="text-3xl mb-3">{f.icon}</div>
                <h3 className="font-semibold text-[#0B3558] mb-2">{f.title}</h3>
                <p className="text-[#60798F] text-sm leading-relaxed">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#1D7ED0] font-semibold text-sm uppercase tracking-widest mb-3">Pricing FAQ</p>
            <h2 className="text-3xl font-bold text-[#0B3558]">Questions about cost</h2>
          </div>
