...
<body style="margin:0;font-family:-apple-system,Segoe UI,sans-serif;background:#1C2B3A;color:#fff;display:flex;min-height:100vh;align-items:center;justify-content:center;text-align:center;">
<div style="max-width:420px;padding:32px;">
  ...
  <a href="${SITE_URL}" style="display:inline-block;margin-top:20px;padding:12px 28px;background:#fff;color:#2C4A6E;font-weight:700;border-radius:10px;text-decoration:none;">Back to cleanngo</a>
</div></body></html>`
