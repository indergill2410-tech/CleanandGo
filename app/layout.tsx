...
export const metadata: Metadata = {
  title: { default: 'Clean&Go | Professional Cleaning Australia-Wide', template: '%s | Clean&Go' },
  ...
  twitter: { card: 'summary_large_image', title: 'Clean&Go', description: 'Book a professional cleaner anywhere in Australia in 60 seconds.' },
  icons: {
    icon: '/favicon.svg',
