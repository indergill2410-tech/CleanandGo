  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'linear-gradient(135deg, #172434 0%, #172434 100%)' }}>
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-20 left-20 w-96 h-96 rounded-full blur-3xl opacity-20" style={{ background: '#8FD8B4' }} />
        <div className="absolute bottom-20 right-20 w-80 h-80 rounded-full blur-3xl opacity-10" style={{ background: '#2F7D6B' }} />
      </div>
      <div className="glass-strong rounded-3xl p-12 w-full max-w-md text-center relative z-10">
        ...
        <div className="flex flex-col gap-3">
          <Link href="/" className="px-8 py-3.5 rounded-xl bg-white text-[#172434] font-bold hover:bg-white/90 transition">Back to Home</Link>
