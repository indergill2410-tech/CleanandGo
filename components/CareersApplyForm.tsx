...
export default function CareersApplyForm() {
  ...
  return (
    <form onSubmit={submit} className="glass-strong rounded-3xl p-7 space-y-4 max-w-lg mx-auto text-left">
      ...
      <button type="submit" disabled={submitting || uploadingKey !== ''} className="w-full py-3.5 rounded-xl bg-white text-[#2C4A6E] font-bold hover:bg-white/90 transition disabled:opacity-50">
